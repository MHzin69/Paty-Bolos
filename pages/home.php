        ...
        <section class="sabores">
            <div class="container">
                ...
                <table class="table table-bordered">
                    ...
                    <tbody> <tr class="sabor-container">
    <td class="sabor-nome">Fruta Abacaxi/Pessêgo
        <button class="btn btn-sm btn-outline-secondary btn-mini" onclick="mostrarIngredientes('igd1')">i</button>
        <!-- <div id="igd1" class="card-ingredientes">leite condensado, creme de leite, maisena, leite e abacaxi ou pêssego</div> -->
    </td>
    <td>R$45,00</td>
</tr>
<tr class="sabor-container">
    <td class="sabor-nome">BomBom
        <button class="btn btn-sm btn-outline-secondary btn-mini" onclick="mostrarIngredientes('igd2')">i</button>
...
<tr class="sabor-container">
    <td class="sabor-nome">Creme de coco c/ abacaxi e doce de leite
        <button class="btn btn-sm btn-outline-secondary btn-mini" onclick="mostrarIngredientes('igd8')">i</button>
...
<tr class="sabor-container">
    <td class="sabor-nome">Creme de doce de leite com coco
        <button class="btn btn-sm btn-outline-secondary btn-mini" onclick="mostrarIngredientes('igd13')">i</button>
...
<tr class="sabor-container">
    <td class="sabor-nome">Brigadeiro
        <button class="btn btn-sm btn-outline-secondary btn-mini" onclick="mostrarIngredientes('igd3')">i</button>
...
<tr class="sabor-container">
    <td class="sabor-nome">Prestígio
        <button class="btn btn-sm btn-outline-secondary btn-mini" onclick="mostrarIngredientes('igd4')">i</button>
...
<tr class="sabor-container">
    <td class="sabor-nome">Cremoso c/ abacaxi
        <button class="btn btn-sm btn-outline-secondary btn-mini" onclick="mostrarIngredientes('igd9')">i</button>
...
<tr class="sabor-container">
    <td class="sabor-nome">Leite ninho c/ doce de leite
        <button class="btn btn-sm btn-outline-secondary btn-mini" onclick="mostrarIngredientes('igd6')">i</button>
...
<tr class="sabor-container">
    <td class="sabor-nome">4 Leite
        <button class="btn btn-sm btn-outline-secondary btn-mini" onclick="mostrarIngredientes('igd5')">i</button>
...
<tr class="sabor-container">
    <td class="sabor-nome">Sensação
        <button class="btn btn-sm btn-outline-secondary btn-mini" onclick="mostrarIngredientes('igd10')">i</button>
...
<tr class="sabor-container">
    <td class="sabor-nome">Leite ninho c/ Morango
        <button class="btn btn-sm btn-outline-secondary btn-mini" onclick="mostrarIngredientes('igd11')">i</button>
...
<tr class="sabor-container">
    <td class="sabor-nome">Floresta Branca c/ morango
        <button class="btn btn-sm btn-outline-secondary btn-mini" onclick="mostrarIngredientes('igd12')">i</button>
...
<tr class="sabor-container">
    <td class="sabor-nome">Leite ninho c/ nutella e morango
        <button class="btn btn-sm btn-outline-secondary btn-mini" onclick="mostrarIngredientes('igd7')">i</button>
